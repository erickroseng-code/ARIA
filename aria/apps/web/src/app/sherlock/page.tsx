...
import { AlertCircle, RefreshCw, Zap, Presentation, Search } from "lucide-react";
...
export default function SherlockPage() {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      console.error("Erro ao buscar dados do Sherlock:", err);
  ...
  const triggerAgent = async () => {
    ...
    try {
      ...
      console.error("Erro ao disparar o Sherlock:", err);
      ...
      <div className="h-full flex flex-col relative z-10 p-6 lg:p-10 max-w-6xl mx-auto flex-1 overflow-y-auto w-full lg:pl-64">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-white/40 text-[13px] ml-13">Inteligência de Tendências Virais · G1 · Google Trends · Reddit · YouTube · Instagram</p>
          </div>
        ...
        <div className="flex-1 space-y-8">
          {loading ? (
            ...
            <div className="bg-violet-500/5 border border-violet-500/20 rounded-3xl p-10 flex flex-col items-center justify-center text-center gap-4">
              ...
              <button
                onClick={fetchDashboardData}
                className="px-6 py-2.5 bg-violet-500/10 hover:bg-violet-500/20 text-violet-400 rounded-lg transition-colors border border-violet-500/20 text-sm font-medium"
              >
                Tentar novamente
              </button>
            </div>
            ...
            <div className="bg-[#09090A] border border-white/5 shadow-2xl rounded-3xl p-16 flex flex-col items-center text-center">
              ...
              <p className="text-white/40 text-sm max-w-lg mb-8 leading-relaxed">
                Nenhum relatório foi processado hoje. O Sherlock executa via GitHub Actions diariamente às 07:00 BRT. Dispare manualmente se necessário.
              </p>
            </div>
          ) : report?.status === "ready" ? (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-4 flex flex-col gap-6">
                ...
                <div className="bg-gradient-to-b from-[#09090A] to-[#09090A] border border-violet-500/20 rounded-3xl p-8 flex-1 shadow-[0_0_40px_rgba(139,92,246,0.05)] relative overflow-hidden group">
